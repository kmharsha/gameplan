  ...
  <div class="flex">
    ...
    <div class="max-w-4xl mx-auto px-4 pt-14">
      <div class="max-w-xl mx-auto">
        <div class="text-2xl font-semibold text-ink-gray-8">👋 Welcome to Khanal Foods Artwork Management System</div>
        
        <div class="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <p class="text-sm text-gray-700 mb-3">
            We're here to make your work faster, easier, and more organized.
          </p>
          <p class="text-sm text-gray-700 mb-2 font-medium">With our Artwork Management System, you can:</p>
          <ul class="text-sm text-gray-600 space-y-1 ml-4">
            <li class="flex items-center">📁 Upload and manage design files</li>
            <li class="flex items-center">🕒 Track artwork progress and approvals</li>
            <li class="flex items-center">🤝 Collaborate with our creative team</li>
            <li class="flex items-center">🔔 Get real-time updates and notifications</li>
          </ul>
        </div>

        <div class="mt-6 pt-6 border-t">
          <h2 class="text-base font-medium text-ink-gray-8 mb-2">Let's create your first project space</h2>
          <p class="text-p-sm text-ink-gray-6">
            A space is where your artwork projects live. Create one for your brand, product line, or any artwork category
            you want to organize and manage.
          </p>
            ...
            <div class="space-x-2 flex items-start w-full">
              ...
              <div class="w-full">
                <FormControl
                  type="text"
                  class="w-full"
                  placeholder="Brand Assets, Product Packaging, Marketing Materials"
                  id="new-space-name"
                  ...
                  maxlength="50"
                  autocomplete="off"
                  description="Give your artwork space a short and descriptive name"
                >
                  <template #suffix>
        ...
        <div class="mt-8 border-t pt-8">
          <h3 class="text-base font-medium text-ink-gray-8 mb-2">Invite creative team members</h3>
          <p class="text-sm text-ink-gray-6">
            Add email addresses of designers, reviewers, and stakeholders you'd like to collaborate with on artwork projects
          </p>
          <div class="mt-3">
            <FormControl
              type="textarea"
              v-model="emailInput"
              placeholder="designer@khanfoods.com, creative-director@khanfoods.com, ..."
              :rows="3"
              class="w-full"
