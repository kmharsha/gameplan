...
let router = createRouter({
  ...
  routes: [
    ...
    },
    {
      name: 'ArtworkTasks',
      path: '/artwork-tasks',
      component: () => import('@/pages/ArtworkTasks.vue'),
    },
    {
      name: 'ArtworkKanban',
      path: '/artwork-kanban',
      component: () => import('@/pages/ArtworkKanban.vue'),
    },
  {
    name: 'ArtworkBucket',
    path: '/artwork-bucket',
    component: () => import('@/pages/ArtworkBucket.vue'),
  },
  {
    name: 'SalesBucket',
    path: '/sales-bucket',
    ...
    {
      name: 'ArtworkTask',
      path: '/artwork-tasks/:taskId',
      component: () => import('@/pages/ArtworkTask.vue'),
      props: true,
    },
    {
      name: 'ApprovedArtworkTasks',
      path: '/artwork-approved',
      component: () => import('@/pages/ApprovedArtworkTasks.vue'),
    },
    {
      name: 'ArtworkManagement',
      path: '/artwork-management',
      component: () => import('@/pages/ArtworkManagement.vue'),
    },
    {
      name: 'ProcurementWorkflow',
      path: '/procurement-workflow',
      component: () => import('@/pages/ProcurementWorkflow.vue'),
    },
    {
      name: 'ProcurementWorkflowDemo',
      path: '/procurement-workflow-demo',
      component: () => import('@/pages/ProcurementWorkflowDemo.vue'),
    },
    {
      name: 'MyPages',
      path: '/pages',
